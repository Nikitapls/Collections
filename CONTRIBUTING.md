...
1. **Ensure you're on the latest version.** Update to the most recent master release if possible.
...
4. Include a `Description` section in the issue. This section should:
    ...
    - **Include screenshots and animated GIFs** which could clearly demonstrate the problem.
